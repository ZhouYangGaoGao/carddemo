...
public class CardView extends FrameLayout {
    ...
    public CardView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        float maxElevation = a.getDimension(R.styleable.CardView_cardMaxElevation, elevation);
        mCompatPadding = a.getBoolean(R.styleable.CardView_cardUseCompatPadding, false);
        mPreventCornerOverlap = a.getBoolean(R.styleable.CardView_cardPreventCornerOverlap, false);
        ...
        mStartColor = a.getColor(R.styleable.CardView_cardStartColor, getResources().getColor(R.color.cardview_shadow_start_color));
        mEndColor = a.getColor(R.styleable.CardView_cardEndColor, getResources().getColor(R.color.cardview_shadow_end_color));
        cropCorner = a.getBoolean(R.styleable.CardView_cardCropCorner, false);
        a.recycle();
    ...
    public void setMaxCardElevation(float maxElevation) {
        IMPL.setMaxElevation(mCardViewDelegate, maxElevation, mStartColor, mEndColor);
    }
