...
//        }
    ...
    public boolean getPadding(Rect padding) {
        ...
        int hOffset = (int) Math.ceil(calculateHorizontalPadding(mRawMaxShadowSize, mCornerRadius,
                mAddPaddingForCorners));
        padding.set(hOffset, (int) (vOffset - mRawMaxShadowSize), hOffset, vOffset);
        return true;
    }
    ...
    private void buildComponents(Rect bounds) {
        ...
        mCardBounds.set(bounds.left + mRawMaxShadowSize, 0.5f * mRawMaxShadowSize,
    ...
    void setMaxShadowSize(float size, int startColor, int endColor) {
